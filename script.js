// Animaciones de fondo (tulipanes, destellos, huellitas)
// Aquí se implementarán usando canvas o SVG

// Galería/carrusel de imágenes
// Próximamente: inicializar galería

// Gatito animado interactivo
// Próximamente: animación y reacciones

// Frases románticas con efecto máquina de escribir
// Próximamente: animar frases

// Reproductor musical
// Próximamente: inicializar reproductor
...
const frases = [
  ...
  'Duende mío, cada día me enamoras más con tu magia. ✨',
  'My lady, eres la reina de mi corazón y mi mundo. 👑',
  'Enana preciosa, contigo todo es más dulce y especial. 🌸',
  'Mi corazón de melón, eres la fruta más dulce de mi vida. 🍉',
  'Dormilona hermosa, despiertas mis mejores sentimientos. 😴💕',
  'Mi princesa, eres la luz que ilumina todos mis días. 👑✨',
  'Mi gatita tierna, tu ronroneo es mi música favorita. 🐱',
  'Mi ángel, has convertido mi vida en un paraíso. 👼',
  'Mi tesoro, eres el regalo más precioso que me ha dado la vida. 💎',
  'Mi sol, tu sonrisa calienta mi corazón cada mañana. ☀️',
  'Mi luna, brillas en mis noches más oscuras. 🌙',
  'Mi estrella, guías mi camino hacia el amor verdadero. ⭐',
  'Mi flor, eres la belleza que hace florecer mi jardín. 🌺',
  'Mi mariposa, vuelas libremente en el jardín de mi corazón. 🦋'
];
